---
title: Introduction to Semantic Event Functions
---
...
*Other custom properties can be included as needed.*
...
*Other custom traits can be included. Refer to `traits.md` for more standard trait names.*
...
*Other custom group traits can be included.*
